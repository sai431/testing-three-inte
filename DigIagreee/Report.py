...
def generate_pdf(file_path, content):
    """
    Generate a PDF file locally with the specified content.

    Parameters:
    - file_path (str): Path to the output PDF file.
    - content (str): Content to be included in the PDF.
    """
    ...
    pdf_canvas.drawString(100, 750, "Generated PDF with Python")
    pdf_canvas.drawString(100, 730, "Content:")
...
(919) 962-771
    ...
    # Generate the PDF
    generate_pdf(pdf_file_path, pdf_content)
